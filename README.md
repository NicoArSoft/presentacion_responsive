# PRESENTACIÓN TFI — "Aprender, construir y enseñar"
**Estudiante:** Dante Nicolás Martínez  
**Espacio:** Actualización Científico-Tecnológica (192 hs) — Prof. Celeste Derra  
**Institución:** IPA Mendoza (Profesorado para la ETP) / UTN FRSR  

---

## 📁 Materiales del Proyecto

### 🖥️ Presentación Interactiva (HTML5 + CSS3 + JS Puro)
- [`index.html`](file:///d:/IPA2026/ACTUALIZACION%20CIENTIFICO%20TECNOLOGICA%202/presentacion_responsive/index.html): Presentación de 8 diapositivas interactivas con custom cursor, animaciones de geometría sagrada, simulador Mobile-First y showcase 3D Coverflow.
- [`estilos.css`](file:///d:/IPA2026/ACTUALIZACION%20CIENTIFICO%20TECNOLOGICA%202/presentacion_responsive/estilos.css): Sistema de tokens de diseño, animaciones GPU y soporte de accesibilidad WCAG AAA.
...
- `◀` / `PageUp`: Retroceder.
- `Inicio` (`Home`): Ir a Portada.
- `Fin` (`End`): Ir al Cierre.
- `T`: Activar / Pausar Timer del Expositor en el HUD.
- `J` / `K`: Navegar el Coverflow 3D en la Slide 7.
- `Esc`: Cerrar modales / Lightbox / Simulador.
